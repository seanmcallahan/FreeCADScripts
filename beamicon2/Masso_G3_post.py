...
# *   Copyright (c) 2024 Sean Callahan <pragmaticus.inc@gmail.com>          *
# *                                                                         *
...
real GCode suitable for a mill with a Beamicon2 board. This postprocessor, once placed
in the appropriate PathScripts folder, can be used directly from inside
FreeCAD, via the GUI importer or via python scripts with:

import beamicon2_post
beamicon2_post.export(object,"/path/to/file.ncc","")
'''

now = datetime.datetime.now()

parser = argparse.ArgumentParser(prog='beamicon2', add_help=False)
...
MACHINE_NAME = "Bulldog 150-100"
CORNER_MIN = {'x': 0, 'y': 0, 'z': 0}
CORNER_MAX = {'x': 1500, 'y': 1000, 'z': 230}
PRECISION = 3

# Preamble text will appear at the beginning of the GCODE output file.
PREAMBLE = '''G17 G40 G64 G54 G43 G90
'''
...
def export(objectslist, filename, argstring):
    ...
    # Insert the percentage sign
    gcode += '%' + "\n"

    # Write the preamble
    if OUTPUT_COMMENTS:
        gcode += "\n" + linenumber() + "(begin preamble)\n"
